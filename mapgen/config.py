...
PAPER_TYPES = {
    ...
    # A3 uses the same frontend dim names but a larger tile grid per page,
    # keeping the same print scale (mirrors the PHP `Splitter` switch: 5x7 ->
    # (7,10), 4x6 -> (6,8), 3x4 -> (4,6), 2x3 -> (3,4), 1x2 -> (2,2)).
    "A3": {
        "dimensions": {
            "5x7": (7, 10, (2110, 2984), (2984, 2110)),
            "4x6": (6, 8, (2110, 2984), (2984, 2110)),
            "3x4": (4, 6, (2110, 2984), (2984, 2110)),
            "2x3": (3, 4, (2110, 2984), (2984, 2110)),
            "1x2": (2, 2, (2110, 2984), (2984, 2110)),
        }
    },
}
